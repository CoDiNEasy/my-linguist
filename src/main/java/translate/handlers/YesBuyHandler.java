...
public class YesBuyHandler implements RequestHandler {
	
	public boolean canHandle(HandlerInput input) {
		return input.matches(Predicates.intentName("YesBuyIntent"));
	}
	...
	public Optional<Response> handle(HandlerInput input) {
		...
		//new state
		attributes.put("SESSION_STAGE", String.valueOf("yesBuy"));
		attributesManager.setSessionAttributes(attributes);
		
		System.out.println("YesBuyIntent");
